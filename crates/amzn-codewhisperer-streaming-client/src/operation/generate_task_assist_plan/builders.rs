...
///
/// [`GenerateTaskAssistPlanOutput`](crate::operation::generate_task_assist_plan::GenerateTaskAssistPlanOutput) contains an event stream field as well as one or more non-event stream fields.
...
impl GenerateTaskAssistPlanFluentBuilder {
    ...
    > {
        ...
        let mut output =
            crate::operation::generate_task_assist_plan::GenerateTaskAssistPlan::orchestrate(&runtime_plugins, input)
                .await?;
