...
///
/// [`ExportResultArchiveOutput`](crate::operation::export_result_archive::ExportResultArchiveOutput) contains an event stream field as well as one or more non-event stream fields.
